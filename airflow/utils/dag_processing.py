...
class DagFileProcessorManager(LoggingMixin):
    ...
    def heartbeat(self):
        ...
        running_processors = {}
        """:type : dict[unicode, AbstractDagFileProcessor]"""
        #获取finished或running状态的DagFileProcess映射数据
        for file_path, processor in self._processors.items():
            if processor.done:
        ...
        #遍历finished的映射数据，生成simple_dag列表
        simple_dags = []
        ...
        # already.
        # 从self._file_path中生成self._file_path_queue
        ...
        # 调用工厂方法处理self._file_path_queue队列中文件
